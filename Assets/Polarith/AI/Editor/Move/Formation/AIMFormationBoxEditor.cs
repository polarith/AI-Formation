...
namespace Polarith.AI.MoveEditor
{
    ...
    [CustomEditor(typeof(AIMFormationBox))]
    internal sealed class AIMFormationBoxEditor : AIMFormationEditor
    {
        #region Fields =================================================================================================
        ...
        {
            get { return serializedObject.FindProperty("formationBox"); }
        }
