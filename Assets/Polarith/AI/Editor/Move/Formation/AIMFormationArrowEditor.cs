...
namespace Polarith.AI.MoveEditor
{
    ...
    [CustomEditor(typeof(AIMFormationArrow))]
    internal sealed class AIMFormationArrowEditor : AIMFormationEditor
    {
        #region Properties =============================================================================================

        public override SerializedProperty BehaviourProperty
        {
            get { return serializedObject.FindProperty("formationArrow"); }
        }
        ...
        public override void DrawBehaviourInspector()
        {
            ...
            if (BehaviourProperty.isExpanded)
            {
                ...
                EditorGUILayout.PropertyField(BehaviourProperty.FindPropertyRelative("solid"));

                SerializedProperty shape = BehaviourProperty.FindPropertyRelative("shape");
