...
namespace Polarith.AI.MoveEditor
{
    ...
    [CustomEditor(typeof(AIMFormationCircle))]
    internal sealed class AIMFormationCircleEditor : AIMFormationEditor
    {
        #region Properties =============================================================================================

        public override SerializedProperty BehaviourProperty
        {
            get { return serializedObject.FindProperty("formationCircle"); }
        }
        ...
        #endregion // Methods
    } // class AIMFormationCircleEditor
} // namespace Polarith.AI.MoveEditor
