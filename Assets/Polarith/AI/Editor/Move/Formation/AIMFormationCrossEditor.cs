...
namespace Polarith.AI.MoveEditor
{
    ...
    [CustomEditor(typeof(AIMFormationCross))]
    internal sealed class AIMFormationCrossEditor : AIMFormationEditor
    {
        #region Properties =============================================================================================

        public override SerializedProperty BehaviourProperty
        {
            get { return serializedObject.FindProperty("formationCross"); }
        }
        ...
        public override void DrawBehaviourInspector()
        {
            ...
            if (BehaviourProperty.isExpanded)
            {
                ...
                EditorGUILayout.PropertyField(BehaviourProperty.FindPropertyRelative("shape"));
